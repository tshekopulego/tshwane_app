...
public class PhoneNumberActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		offlineMessage = (View) findViewById(R.id.container_offline);

		registerView = (View) findViewById(R.id.deviceReg);
		...
		captureBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (mobileNo.isEmpty()) {
					// Internet Connection is not present
					alert.showAlertDialog(v.getContext(), "Phone Number", "Please enter your phone number", false);
					// stop executing code by
					return;
				...
				if (mobileNo.length() < 10) {
					// Internet Connection is not present
					alert.showAlertDialog(v.getContext(), "Phone Number", "Invalid phone number, Please try again",
							false);
					// stop executing code by
					return;
