...
public class CrimeReportDetail extends CustomActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (!lat.isEmpty() || !lot.isEmpty()) {
			...
			LinearLayout parent = (LinearLayout) mMapView.getParent();
	...
	private class NotificationsAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				convertView = inflater.inflate(R.layout.crimereportlist_item, null); //it was null
			}
	...
	private void setupMarker(String lat, String lot) {
		...
		opt.position(l).title(title).snippet(subtitle);
	...
	DialogInterface.OnClickListener dialogClickListener = new DialogInterface.OnClickListener() {
		...
		public void onClick(DialogInterface dialog, int which) {
			...
			case DialogInterface.BUTTON_POSITIVE:
				// Yes button clicked
				mydb.deleteCrimeReport(uid);
				mydb.deleteNotification(uid);

				Intent i = new Intent("crimereported_deleted");
