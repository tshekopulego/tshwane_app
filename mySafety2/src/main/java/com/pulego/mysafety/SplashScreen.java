...
public class SplashScreen extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Intent i = new Intent(com.pulego.mysafety.SplashScreen.this, com.pulego.mysafety.MainActivity.class);
	...
	private synchronized void doFinish() {
		...
		if (isRunning) {
			...
			if (regid.isEmpty()) {
				Intent i = new Intent(com.pulego.mysafety.SplashScreen.this,
						com.pulego.mysafety.phoneNumberActivity.class);
				i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
				startActivity(i);
			} else {
				Intent i = new Intent(com.pulego.mysafety.SplashScreen.this, com.pulego.mysafety.MainActivity.class);
